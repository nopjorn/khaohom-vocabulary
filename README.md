...
จุดเด่น: เป็นเว็บยอดนิยมอันดับต้นๆ ภาพส่วนใหญ่มีคุณภาพสูงมาก (High Resolution) มีสไตล์ศิลปะ ดูทันสมัย มู้ดแอนด์โทนสวยงาม เหมาะกับงานออกแบบที่ต้องการความพรีเมียมและดูทันสมัย

2. Pexels (pexels.com)
จุดเด่น: มีรูปภาพสวยๆ หลากหลายแนว และจุดเด่นอีกอย่างคือมีวิดีโอฟรี (Stock Video) ให้ดาวน์โหลดไปใช้งานด้วย ระบบค้นหาทำได้ดี และรองรับการค้นหาด้วยภาษาไทยในระดับหนึ่ง

3. Pixabay (pixabay.com)
จุดเด่น: มีคลังภาพขนาดใหญ่มาก นอกจากรูปถ่ายแล้ว ยังมีภาพวาดกราฟิก (Illustrations), ภาพเวกเตอร์ (Vectors) รวมถึงเพลงและเอฟเฟกต์เสียงฟรีให้โหลดอีกด้วย เป็นเว็บที่ครบเครื่องมาก

4. Freepik (freepik.com) มีเงื่อนไขเพิ่มเติม
จุดเด่น: แหล่งรวมไฟล์เวกเตอร์และรูปภาพที่คนทำงานกราฟิกชอบใช้ มีทั้งแบบฟรีและเสียเงิน

ข้อควรระวัง: สำหรับบัญชีฟรี จำเป็นต้องใส่เครดิต (Attribution) ให้กับทางเว็บตามเงื่อนไขที่กำหนด หากไม่ต้องการใส่เครดิตต้องสมัครสมาชิกแบบ Premium ครับ

5. Burst by Shopify (burst.shopify.com)
จุดเด่น: สร้างโดยแพลตฟอร์ม E-commerce อย่าง Shopify ภาพส่วนใหญ่จึงเน้นไปที่แนวธุรกิจ สินค้า สตาร์ทอัพ และไลฟ์สไตล์ เหมาะมากสำหรับพ่อค้าแม่ค้าออนไลน์หรือผู้ที่ต้องการรูปภาพไปทำคอนเทนต์การตลาด